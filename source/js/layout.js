...
const navbar=new Navbar(".cb-menu");
...
const FloatingContactElm = document.querySelector(".cb-intouch");
const floatingButtonContact = new FloatingButtonContact(FloatingContactElm);
