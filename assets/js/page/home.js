...
function pageTransitionIn(e) {
  var _console;
  /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("1918873423_308_4_308_18_4", e)));
  var tl = gsap__WEBPACK_IMPORTED_MODULE_3__["default"].timeline();
...
function pageTransitionOut(e) {
  ...
  // console.log(e)
  var tl = gsap__WEBPACK_IMPORTED_MODULE_3__["default"].timeline();
  var LoadingActiveLast = document.querySelector('.home-active-last');
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                /* eslint-disable */
                (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1918873423_469_16_469_38_4", data.next)));
