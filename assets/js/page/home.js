...
var Modal = /*#__PURE__*/function () {
  ...
  _createClass(Modal, [{
    key: "bindCloses",
    value: function bindCloses() {
      var _this = this;
      this.el.querySelectorAll("[data-modal-close]").forEach(function (closeButton) {
    ...
    key: "bindOpens",
    value: function bindOpens() {
      var _this2 = this;
      if (this.el && this.el.id) {
        document.querySelectorAll("[data-modal-open='#".concat(this.el.id, "']")).forEach(function (openButton) {
          var _console;
          /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("2977576460_26_16_26_39_4", openButton)));
    ...
    value: function show() {
      ...
      this.visibleInt = setTimeout(function () {
        _this3.el.classList.add("-visible");
      }, this.showTimeout);
    ...
    value: function hide() {
      ...
      clearTimeout(this.visibleInt);
      this.visibleInt = setTimeout(function () {
        _this4.el.classList.remove("-show");
...
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap/ScrollTrigger */ "./node_modules/gsap/ScrollTrigger.js");
/* harmony import */ var _modules_Divider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/Divider */ "./source/js/modules/Divider.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var Footer = /*#__PURE__*/function () {
  ...
  _createClass(Footer, [{
    ...
    key: "magicParallax",
    value: function magicParallax() {
      var _this = this;
      // Save styles and set up media query
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.saveStyles([this.main]);
      gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.matchMedia({
        "(min-width:1050px)": function minWidth1050px() {
          // Create GSAP ScrollTrigger with animation
          gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
            animation: _this.tlParallax(),
    ...
    key: "tlParallax",
    value: function tlParallax() {
      var timeline = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline(); // Use GSAP for creating the timeline
      // Define the GSAP animation sequence
      timeline.set(this.footer, {
        willChange: "transform"
      });
      timeline.fromTo(this.footer, {
        yPercent: -50
      }, {
        yPercent: 0,
        ease: "none",
    ...
    key: "footerDivider",
    value: function footerDivider() {
      var dividerElement = document.querySelector('.footer__divider-container');
      if (dividerElement) {
        var divider = new _modules_Divider__WEBPACK_IMPORTED_MODULE_0__["default"](dividerElement);
...
/***/ "./source/js/sections/HomeBanner.js":
/*!******************************************!*\
  !*** ./source/js/sections/HomeBanner.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var HomeBanner = /*#__PURE__*/function () {
  ...
  _createClass(HomeBanner, [{
    ...
    key: "titleSplit",
    value: function titleSplit() {
      this.playAnimate = '';
      this.elmToSplit = new split_type__WEBPACK_IMPORTED_MODULE_0__["default"](this.sectionTitle, {
        types: "lines, words",
        tagName: "span"
      });
      var titleWords = this.sectionTitle.querySelectorAll('.word');
    ...
    key: "animateWord",
    value: function animateWord() {
      var wordInners = this.sectionTitle.querySelectorAll('.word-inner');
      var options = {
        fromY: "120%",
        toY: "0",
        type: "words",
      ...
      if (wordInners) {
        gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(wordInners, {
          y: options.fromY
        });
        tl.set(wordInners, {
          willChange: "transform"
    ...
    key: "handlePlayAnimate",
    value: function handlePlayAnimate() {
...
/***/ "./source/js/sections/HomePreviews.js":
/*!********************************************!*\
  !*** ./source/js/sections/HomePreviews.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var HomePreviews = /*#__PURE__*/function () {
  function HomePreviews() {
    _classCallCheck(this, HomePreviews);
  ...
  _createClass(HomePreviews, [{
    ...
    key: "tlShow",
    value: function tlShow() {
      var timeline = new gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline();
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(this.previewMedia, {
        opacity: 0
      });
      timeline.to(this.previewMedia, {
        opacity: 1,
        duration: 1
      });
      return timeline;
    ...
    value: function tlParallax() {
      ...
      timeline.fromTo(this.previewMedia, {
        y: "-10%"
      }, {
        y: "10%",
        ease: "none"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (HomePreviews);
...
/* harmony import */ var _sections_HomeBanner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../sections/HomeBanner */ "./source/js/sections/HomeBanner.js");
/* harmony import */ var _sections_HomePreviews__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../sections/HomePreviews */ "./source/js/sections/HomePreviews.js");
/* harmony import */ var _modules_MasonryLayout__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../modules/MasonryLayout */ "./source/js/modules/MasonryLayout.js");
/* harmony import */ var _sections_SectionFeatures__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../sections/SectionFeatures */ "./source/js/sections/SectionFeatures.js");
/* harmony import */ var _sections_SectionPortfolio__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../sections/SectionPortfolio */ "./source/js/sections/SectionPortfolio.js");
/* harmony import */ var _modules_ScrollLetters__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../modules/ScrollLetters */ "./source/js/modules/ScrollLetters.js");
/* harmony import */ var _modules_Divider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../modules/Divider */ "./source/js/modules/Divider.js");
//1.Import
...
var homeBanner = new _sections_HomeBanner__WEBPACK_IMPORTED_MODULE_2__["default"]();
var homePreviews = new _sections_HomePreviews__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
var scrollLetters = new _modules_ScrollLetters__WEBPACK_IMPORTED_MODULE_9__["default"]();
var masonryLayout = new _modules_MasonryLayout__WEBPACK_IMPORTED_MODULE_6__["default"]();
var featuredElm = document.querySelector(".featured");
var portfolioElm = document.querySelector(".portfolio");
var sectionFeatured = new _sections_SectionFeatures__WEBPACK_IMPORTED_MODULE_7__["default"](featuredElm);
var sectionPortfolio = new _sections_SectionPortfolio__WEBPACK_IMPORTED_MODULE_8__["default"](portfolioElm);
...
function portfolio() {
  ...
  for (var i = 0; i < masonryContainerTotal; i++) {
    masonryLayout.fetchMasonry("masonry".concat(i), 'card-portfolio', 3);
  }
}
document.addEventListener("DOMContentLoaded", function () {
  var dividerElement = document.querySelector('.divider-container');
  if (dividerElement) {
    var divider = new _modules_Divider__WEBPACK_IMPORTED_MODULE_10__["default"](dividerElement);
    divider.onInit(); // This will start the animation and setup
  }
});
})();
