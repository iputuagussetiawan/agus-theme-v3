        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              // sectionFeatured.onInit()
              /* eslint-disable */
              (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3872732340_68_12_68_44_4", 'testees From Home')));
              pageTransition();
            case 2:
            case "end":
