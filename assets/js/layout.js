...
mouse_follower__WEBPACK_IMPORTED_MODULE_1__["default"].registerGSAP(gsap__WEBPACK_IMPORTED_MODULE_2__["default"]);
var navbar = new _modules_Navbar__WEBPACK_IMPORTED_MODULE_0__["default"](".cb-menu");
var cursor = new mouse_follower__WEBPACK_IMPORTED_MODULE_1__["default"]({
  stateDetection: {
    '-pointer': 'a,button',
    '-opaque': '.my-image',
    '-hidden': '.my-input'
...
navbar.onInit();
var Magnetic = function Magnetic(elm, options) {
  var cursorPosition;
  ...
  var rePosition = function rePosition(xPosition, yPosition, params) {
    gsap__WEBPACK_IMPORTED_MODULE_2__["default"].to(elm, _objectSpread({
      x: xPosition,
      y: yPosition,
      overwrite: param.overwrite,
      onStart: function onStart() {
        gsap__WEBPACK_IMPORTED_MODULE_2__["default"].set(elm, {
...
var FloatingButtonContact = /*#__PURE__*/function () {
  function FloatingButtonContact(el) {
    _classCallCheck(this, FloatingButtonContact);
    this.el = el;
    this.video = this.el.querySelector(".cb-intouch-video");
  }
  _createClass(FloatingButtonContact, [{
    key: "onInit",
  ...
  return FloatingButtonContact;
}();
var FloatingContactElm = document.querySelector(".cb-intouch");
var floatingButtonContact = new FloatingButtonContact(FloatingContactElm);
floatingButtonContact.onInit();
...
var Navbar = /*#__PURE__*/function () {
  ...
  _createClass(Navbar, [{
    ...
    value: function onInit() {
      var _console;
      /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("2118693143_0", this.el)));
      try {
        this.bindToggle();
        return Promise.resolve();
      } catch (error) {
